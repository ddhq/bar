...
bootstrap-table Show bootstrap-table-group-by.js Source code
Return Download bootstrap-table： download bootstrap-table-group-by.js Source code - Download bootstrap-table Source code - Type:.js
*/
/**
    ...
    BootstrapTable.prototype.initBody = function () {
        ...
        if ((this.options.groupBy) && (this.options.groupByField !== '')) {
            ...
            tableGroups.forEach(function(item){
				...
				if (that.options.groupsRenderer) {
                    var groupRenderHtml = that.options.groupsRenderer(item);
					html.push('<td',
